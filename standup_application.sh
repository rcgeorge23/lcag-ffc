...
docker run -d \
	...
	-e "EXISTING_MEMBER_THANK_YOU_FOR_YOUR_DONATION_EMAIL_SOURCE_URL=https://docs.google.com/document/d/1TS2ym_lv5uszANO4P3EWhqRXf95BmVCC9iTPXVx3ayU/export?format=html" \
	-e "EXISTING_MEMBER_THANK_YOU_FOR_YOUR_DONATION_EMAIL_SUBJECT=Thank you for your litigation donation" \
